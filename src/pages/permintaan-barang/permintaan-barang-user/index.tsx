...
const PermintaanBarangUserPage = () => {
    ...
    <main className="base-card  gap-3 h-[calc(100dvh-100px)] relative bg-gradient-to-b from-slate-50 to-blue-400 shadow">
      ...
      <section className="flex flex-col w-full overflow-hidden scroll col-span-4 lg:col-span-3">
        <div className="flex flex-col lg:flex-row gap-3 justify-between">
          <h1 className="text-xl md:text-2xl font-bold mb-2">Daftar Barang</h1>
        </div>
      ...
      >
        ...
        <div className="flex flex-row items-center gap-4">
          ...
          <Button
            className="w-full"
            onClick={() => {
              navigate("/keranjang-barang", { state: { cartItem } });
            }}
          >
            Ajukan
          </Button>
...
export default PermintaanBarangUserPage;
